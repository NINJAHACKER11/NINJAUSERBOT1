...
from NINJABOT import ALIVE_NAME, CmdHelp
from NINJABOT import bot as NINJABOT
from NINJABOT.utils import admin_cmd
from NINJABOT.utils import edit_or_reply as eor
from NINJABOT.utils import sudo_cmd
...
@NINJABOT.on(admin_cmd(pattern="hvd$"))
@NINJABOT.on(sudo_cmd(pattern="hvd$", allow_sudo=True))
...
@NINJABOT.on(admin_cmd(pattern="vday$"))
@NINJABOT.on(sudo_cmd(pattern="vday$", allow_sudo=True))
async def gif(event):
    if event.fwd_from:
        return
