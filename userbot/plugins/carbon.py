...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "NINJA User"
...
async def carbon_api(e):
    ...
    NINJA = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await NINJA.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await NINJA.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await NINJA.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by NINJABOT",
        force_document=True,
...
async def carbon_api(e):
    if e.fwd_from:
        return
    NINJA = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await NINJA.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
...
async def carbon_api(e):
    ...
    await NINJA.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await NINJA.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await NINJA.delete()  # Deleting msg
...
async def carbon_api(e):
    ...
    await NINJA.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await NINJA.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await NINJA.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await NINJA.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await NINJA.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await NINJA.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await NINJA.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await NINJA.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await NINJA.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await NINJA.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
