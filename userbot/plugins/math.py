...
@NINJABOT.on(admin_cmd(pattern="sin ?(.*)"))
@NINJABOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@NINJABOT.on(admin_cmd(pattern="cos ?(.*)"))
@NINJABOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@NINJABOT.on(admin_cmd(pattern="tan ?(.*)"))
@NINJABOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@NINJABOT.on(admin_cmd(pattern="cosec ?(.*)"))
@NINJABOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@NINJABOT.on(admin_cmd(pattern="sec ?(.*)"))
@NINJABOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@NINJABOT.on(admin_cmd(pattern="cot ?(.*)"))
@NINJABOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@NINJABOT.on(admin_cmd(pattern="square ?(.*)"))
@NINJABOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@NINJABOT.on(admin_cmd(pattern="cube ?(.*)"))
@NINJABOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
