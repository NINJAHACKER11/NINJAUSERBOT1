...
@NINJABOT.on(admin_cmd(pattern=r"unpack", outgoing=True))
@NINJABOT.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@NINJABOT.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@NINJABOT.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
