...
async def _(event):
    ...
    NINJAevent = await event.reply(f"{name} is ejected.......🤐")
    await asyncio.sleep(2)
    await NINJAevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await NINJAevent.edit("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
...
async def _(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    NINJAevent = await edit_or_reply(event, f"{name} is ejected.......")
    await asyncio.sleep(2)
    await NINJAevent.edit("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
