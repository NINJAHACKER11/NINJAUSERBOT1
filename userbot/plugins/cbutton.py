...
CmdHelp("cbutton").add_command(
    ...
    None,
    "Use And See",
    "cbutton Test [Google]<buttonurl:https://www.google.com> [Support]<buttonurl:https://t.me/officialninjauserbot:same> [Channel]<buttonurl:https://t.me/officialninjabotsupport>",
