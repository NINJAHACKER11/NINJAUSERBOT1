...
async def _(event):
    ...
    NINJAevent = await edit_or_reply(event, "Downloading to my local, for analysis  🙇")
    if event.reply_to_msg_id:
        ...
        if (
            ...
            await NINJAevent.edit("Starting analysis, using IBM WatSon Speech To Text")
            headers = {
            ...
            if "results" in r:
                ...
                await NINJAevent.edit(string_to_show)
            else:
                await NINJAevent.edit(r["error"])
