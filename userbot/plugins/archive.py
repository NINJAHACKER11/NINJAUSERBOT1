...
from NINJABOT.utils import admin_cmd, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await borg.send_file(
                event.chat_id,
                directory_name + ".7z",
                caption="7z archived By NINJABOT",
                force_document=True,
                allow_cache=False,
                reply_to=event.message.id,
            )
