...
from NINJABOT.utils import admin_cmd, errors_handler, sudo_cmd
from userbot import BOTLOG, BOTLOG_CHATID
from userbot import bot as NINJABOT


@NINJABOT.on(admin_cmd(outgoing=True, pattern="del$"))
@NINJABOT.on(sudo_cmd(allow_sudo=True, pattern="del$"))
@errors_handler
