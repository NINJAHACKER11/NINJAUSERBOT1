...
async def variable(var):
    ...
    if exe == "get":
        ...
        try:
            ...
            if "NINJA_STRING" in variable:
                await eor(
                    var, "ninja String is a Sensetive Data.\nProtected By ninjaBot"
                )
                return
...
async def _(event):
    ...
    NINJA_data = app.get_log()
    await eor(event, NINJA_data)
