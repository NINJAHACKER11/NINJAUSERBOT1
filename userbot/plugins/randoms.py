# Made By @The_NinjaHacker. Keep Credit if you are gonna copy paste it. LOL NOOBS....
...
async def _(event):
    ...
    if x == 53:
        await event.edit(
            '`"Be mindful of poorer friends when suggesting splitting the bill equally in a restNinjant. Some people will choose cheaper options because they\'re on a budget."`'
        )
    if x == 54:
        await event.edit(
