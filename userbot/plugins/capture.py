...
async def _(event):
    ...
    if Config.GOOGLE_CHROME_BIN is None:
        ...
        return
    Ninja = await eor(event, "Processing ...weit")
    ...
    try:
        ...
        with io.BytesIO(im_png) as out_file:
            out_file.name = "ninjabot.ScreenCapture.PNG"
            await bot.send_file(
                event.chat_id,
                out_file,
                caption=input_str,
        ...
        await eod(Ninja, traceback.format_exc())
...
CmdHelp("capture").add_command(
    ...
    "screenshot https://github.com/NINJA-OS/NINJABOT",
