...
async def _(event):
    ...
    process = await asyncio.create_subprocess_sNINJA(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [NINJABOT](t.me/ninja_Userbot) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
    "ls_local", None, "Gives the list of downloaded medias in your NINJABOT server."
).add_command(
    "ls_root", None, "Gives the list of all files in root directory of NINJABOT repo."
).add_command(
    "ls_saved",
    None,
    "Gives the list of all files in Saved directory of your NINJABOT server",
).add_command(
