...
if ENV:
    ...
    class Config(object):
        ...
        # emoji to be displayed  in help .ninja
        ...
        ALIVE_PIC = (
            ...
            or "https://te.legra.ph/file/1fef0a4acf69bfb85c511.jpg"
        )
        PM_PIC = (
        ...
        ALIVE_MSG = os.environ.get("ALIVE_MSG", None) or "NINJAUSERBOT Is Online"
        PM_MSG = os.environ.get("PM_MSG", None)
        INSTANT_BLOCK = os.environ.get("INSTANT_BLOCK", "DISABLE")
        YOUR_GROUP = os.environ.get("YOUR_GROUP", "@officialninjauserbot")
        YOUR_CHANNEL = os.environ.get("YOUR_CHANNEL", "@officialninjabotsupport.")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/NINJAHACKER11/NINJAUSERBOT"
        )
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "NINJABOT")
        ...
        # number of rows of buttons to be displayed in .ninja command
        ...
        # number of colums of buttons to be displayed in .ninja command
